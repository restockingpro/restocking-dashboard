...
// se não tiver env, usa a anon antiga que você já tinha (pra não ficar vazio no deploy)
  ...
  return (
    <>
      <div className="page-header">
        ...
        <p>
          Manage all supplier URLs you want RestocKING to monitor. By adding your
          links here, you’ll receive instant alerts the moment stock returns —
          giving you the advantage of restocking ahead of competitors.
        </p>
      </div>
...
/* -------- RESTOCK ALERTS SECTION (ANTIGO + DATA) -------- */
type RestockAlert = {
  id?: string;
  created_at?: string;
